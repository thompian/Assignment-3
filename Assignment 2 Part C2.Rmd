...
sum(is.na(polyplacophora.filter$country))
sum(is.na(polyplacophora.filter$bin_uri))
sum(is.na(polyplacophora.filter$lat))
sum(is.na(polyplacophora.filter$species_name))
```
